...
public class MovieListServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
    	...
    	String SearchServlet = getServletContext().getRealPath("/WEB-INF") + "/SearchServletMovieList.txt";
    	String JDBCTime = getServletContext().getRealPath("/WEB-INF") + "/JDBCMovieList.txt";
