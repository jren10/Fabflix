...
@WebServlet(name = "FormNoPoolServlet", urlPatterns = "/api/movielistnopool")
public class MovieListServletNoPool extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
    	...
    	// testing time/writing to file
    	String SearchServlet = getServletContext().getRealPath("/WEB-INF") + "/SearchServletMovieListNoPool.txt";
    	String JDBCTime = getServletContext().getRealPath("/WEB-INF") + "/JDBCMovieListNoPool.txt";
